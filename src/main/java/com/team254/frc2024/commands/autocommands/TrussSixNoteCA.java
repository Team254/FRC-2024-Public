...
/**
 * Truss auto mode that shoots preload, three close, and notes C and A from
 * midline.
 */
public class TrussSixNoteCA extends PathFollowingAutoModeCommandGroup {
    public TrussSixNoteCA(RobotContainer container) {
        super(container, "Truss3Plus2_CA", true);
