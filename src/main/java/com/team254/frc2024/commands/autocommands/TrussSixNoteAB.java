...
/**
 * Truss auto mode that shoots preload, three close, and notes A and B from
 * midline.
 */
public class TrussSixNoteAB extends PathFollowingAutoModeCommandGroup {
    public TrussSixNoteAB(RobotContainer container) {
        super(container, "Truss3Plus2_AB", true);
