...
public class AdvancedFollowPathHolonomic extends AdvancedFollowPathCommand {
    /**
     ...
     *                             the drive subsystem
     */
    public AdvancedFollowPathHolonomic(
        ...
        super(
                ...
                speedsSupplier,
                outputRobotRelative,
                new AdvancedHolonomicDriveController(
                        translationConstants, rotationConstants, translationKa, period, maxModuleSpeed,
                        driveBaseRadius),
                replanningConfig,
                shouldFlipPath,
                requirements);
