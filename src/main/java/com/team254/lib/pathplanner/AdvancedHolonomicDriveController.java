...
public class AdvancedHolonomicDriveController implements AdvancedPathFollowingController {
    ...
    public AdvancedHolonomicDriveController(
        ...
        this.xController = new PIDVController(
        ...
        this.yController = new PIDVController(
                translationConstants.kP, translationConstants.kI, translationConstants.kD, period);
    ...
    public AdvancedHolonomicDriveController(
            ...
            double maxModuleSpeed,
            double driveBaseRadius) {
        this(translationConstants, rotationConstants, translationKa, 0.02, maxModuleSpeed, driveBaseRadius);
    }
    ...
    public ChassisSpeeds calculateRobotRelativeSpeeds(
        ...
        double angularAccelRobotFrame = targetState.curvatureRadPerMeter * targetState.velocityMps
        ...
        double xFeedback = this.xController.calculate(currentPose.getX(), v.getX(), targetState.positionMeters.getX(),
                xFF);
        double yFeedback = this.yController.calculate(currentPose.getY(), v.getY(), targetState.positionMeters.getY(),
                yFF);
        ...
        double rotationFeedback = rotationController.calculate(
                ...
                new TrapezoidProfile.State(targetRotation.getRadians(),
                        targetState.holonomicAngularVelocityRps.orElse(0.0)),
                rotationConstraints);
        double rotationFF = rotationController.getSetpoint().velocity;

        return ChassisSpeeds.fromFieldRelativeSpeeds(
                xFF + xFeedback + xAccelFF * translationKa, yFF + yFeedback + yAccelFF * translationKa,
