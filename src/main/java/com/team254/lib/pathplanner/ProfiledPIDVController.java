 ...
 * behavior.
 */
public class ProfiledPIDVController implements Sendable {
    private static int instances;

    private PIDVController m_controller;
    ...
    public ProfiledPIDVController(
        ...
        m_controller = new PIDVController(Kp, Ki, Kd, period);
