...
public class AdvancedFollowPathCommand extends Command {
    private final Timer timer = new Timer();
    private final PathPlannerPath originalPath;
    private final Supplier<Pose2d> poseSupplier;
    private final Supplier<ChassisSpeeds> speedsSupplier;
    private final Consumer<ChassisSpeeds> output;
    private final AdvancedPathFollowingController controller;
     ...
     *                            speeds of this
     *                            command
     * @param controller          Path following controller that will be used to
     *                            follow the path
     ...
     *                            the drive subsystem
     */
    public AdvancedFollowPathCommand(
            PathPlannerPath path,
            Supplier<Pose2d> poseSupplier,
            Supplier<ChassisSpeeds> speedsSupplier,
            Consumer<ChassisSpeeds> outputRobotRelative,
            AdvancedPathFollowingController controller,
    ...
    public void initialize() {
        ...
        Rotation2d targetHeading = path.getPoint(1).position.minus(path.getPoint(0).position).getAngle();
